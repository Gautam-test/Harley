...
//
// Lookup is by 3-digit prefix (110, 122, 400 …). Unknown prefixes return null,
// in which case the API skips the distance filter rather than silently lying.
//
// Coordinates sourced from the largest city in each sub-region. Add more
// prefixes here as new dealer cities come online.
