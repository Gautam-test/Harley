...
// does NOT redirect to /dashboard (which would silently trigger the
// dashboard's queries for what is clearly a typoed / probed URL). The
// admin sees a deterministic "this page doesn't exist" instead of a
// dashboard load happening behind the scenes.
export function NotFoundPage() {
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center px-4 text-center">
      ...
      {/* Secondary navigation — quick jumps to the most-used admin
          sections so the admin doesn't have to navigate via the
